...
namespace NK
{
	...
	void VulkanDevice::CreateLogicalDevice()
	{
		...
		features12.shaderSampledImageArrayNonUniformIndexing = VK_TRUE; //Enable HLSL NonUniformResourceIndex keyword for non-uniform indexing into SRVs
		features12.shaderStorageImageArrayNonUniformIndexing = VK_TRUE; //Enable HLSL NonUniformResourceIndex keyword for non-uniform indexing into UAVs
...
//		createInfo.pDeviceMemoryCallbacks = m_allocator.GetVMACallbacks();
	...
	VkBool32 VulkanDevice::DebugCallback(VkDebugUtilsMessageSeverityFlagBitsEXT _messageSeverity, VkDebugUtilsMessageTypeFlagsEXT _messageType, const VkDebugUtilsMessengerCallbackDataEXT* _pCallbackData, void* _pUserData)
	{
		...
		switch (_messageType)
		{
		case VK_DEBUG_UTILS_MESSAGE_TYPE_GENERAL_BIT_EXT:		layer = LOGGER_LAYER::VULKAN_GENERAL; break;
		case VK_DEBUG_UTILS_MESSAGE_TYPE_VALIDATION_BIT_EXT:	layer = LOGGER_LAYER::VULKAN_VALIDATION; break;
		case VK_DEBUG_UTILS_MESSAGE_TYPE_PERFORMANCE_BIT_EXT:	layer = LOGGER_LAYER::VULKAN_PERFORMANCE; break;
