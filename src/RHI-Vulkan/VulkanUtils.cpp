...
namespace NK
{
	...
	VkBufferUsageFlags VulkanUtils::GetVulkanBufferUsageFlags(const BUFFER_USAGE_FLAGS _flags)
	{
		...
		if (EnumUtils::Contains(_flags, BUFFER_USAGE_FLAGS::STORAGE_BUFFER_BIT))	{ vkFlags |= VK_BUFFER_USAGE_STORAGE_BUFFER_BIT; }
	...
	BUFFER_USAGE_FLAGS VulkanUtils::GetRHIBufferUsageFlags(const VkBufferUsageFlags _flags)
	{
		...
		if (_flags & VK_BUFFER_USAGE_STORAGE_BUFFER_BIT) { rhiFlags |= BUFFER_USAGE_FLAGS::STORAGE_BUFFER_BIT; }
