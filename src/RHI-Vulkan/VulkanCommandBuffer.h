...
namespace NK
{
	...
	public:
		...
		virtual void BeginRendering(std::size_t _numColourAttachments, ITextureView* const* _multisampleColourAttachments, ITextureView* const* _outputColourAttachments, ITextureView* _multisampleDepthAttachment, ITextureView* _outputDepthAttachment, ITextureView* _stencilAttachment, bool _clearRTVs=true, bool _clearDSV=true) override;
		...
		virtual void BeginRendering(std::size_t _numColourAttachments, ITextureView* const* _multisampleColourAttachments, ITextureView* const* _outputColourAttachments, ITextureView* _depthStencilAttachment, bool _clearRTVs=true, bool _clearDSV=true) override;
