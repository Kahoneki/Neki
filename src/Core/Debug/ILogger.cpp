...
namespace NK
{
	...
	std::string ILogger::LayerToString(const LOGGER_LAYER _layer)
	{
		...
		case LOGGER_LAYER::RENDER_SYSTEM:				return "[RENDER SYSTEM]";
		case LOGGER_LAYER::NETWORK_SYSTEM:				return "[NETWORK SYSTEM]";
		case LOGGER_LAYER::NETWORK_SYSTEM_CLIENT:		return "[NETWORK SYSTEM CLIENT]";
		case LOGGER_LAYER::NETWORK_SYSTEM_SERVER:		return "[NETWORK SYSTEM SERVER]";
