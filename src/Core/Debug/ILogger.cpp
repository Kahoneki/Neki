...
namespace NK
{
	...
	std::string ILogger::LayerToString(const LOGGER_LAYER _layer)
	{
		...
		case LOGGER_LAYER::MODEL_VISIBILITY_LAYER:		return "[MODEL VISIBILITY LAYER]";
		case LOGGER_LAYER::WINDOW_LAYER:				return "[WINDOW LAYER]";
		case LOGGER_LAYER::PHYSICS_LAYER:				return "[PHYSICS LAYER]";
