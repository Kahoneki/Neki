...
namespace NK
{
	...
	protected:
		explicit IRootSignature(ILogger& _logger, IAllocator& _allocator, IDevice& _device, RootSignatureDesc _desc)
		: m_logger(_logger), m_allocator(_allocator), m_device(_device), m_providedNum32BitPushConstantValues(_desc.num32BitPushConstantValues) {}
